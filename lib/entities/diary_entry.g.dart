...
extension DiaryEntryQueryFilter
  ...
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterFilterCondition> entryDateEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterFilterCondition> entryDateLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterFilterCondition> entryDateBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DiaryEntryQueryLinks
    on QueryBuilder<DiaryEntry, DiaryEntry, QFilterCondition> {
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterFilterCondition> diary(
      FilterQuery<Diary> q) {
    return QueryBuilder.apply(this, (query) {
...
extension DiaryEntryQuerySortBy
  ...
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterSortBy> sortByEntryDate() {
    return QueryBuilder.apply(this, (query) {
...
extension DiaryEntryQuerySortThenBy
  ...
  QueryBuilder<DiaryEntry, DiaryEntry, QAfterSortBy> thenByEntryDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entryDate', Sort.asc);
    });
  }

  QueryBuilder<DiaryEntry, DiaryEntry, QAfterSortBy> thenByEntryDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'entryDate', Sort.desc);
    });
  }
